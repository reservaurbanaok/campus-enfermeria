window.CONFIG = {
  API_URL: "https://script.google.com/macros/s/AKfycbzj_itn9OiL1P2u0nRKRgreKlMsulQrW-5xAZ0wuiOJvbwUrSktIBMiDWuu4786j5pvtQ/exec",
  GA4_URL: "https://script.google.com/macros/s/AKfycbzj_itn9OiL1P2u0nRKRgreKlMsulQrW-5xAZ0wuiOJvbwUrSktIBMiDWuu4786j5pvtQ/exec?tipo=ga4",
  LUCA_URL: "https://script.google.com/macros/s/AKfycbyyIusx-c7n9ZWnAdVhNigkkWfLXr1qX1l_lL7udNbZFhxHOK5yIb8l6cSfs-qbkHUGjg/exec?tipo=luca"
};
...
(function initLucaDashboard() {
  ...
  function ensureLucaSection() {
    ...
    const html = '<div id="lucaSection"><div class="section-title">Inteligencia Comercial Luca - WhatsApp e Instagram</div>' +
      ...
      '<div class="card"><h3>Ultimas Conversaciones</h3><table><thead><tr><th>Fecha</th><th>WhatsApp</th><th>Curso</th><th>Etapa</th><th>Mensaje</th></tr></thead><tbody id="l_recientes"><tr><td colspan="5" style="color:var(--muted);text-align:center;padding:18px">Cargando...</td></tr></tbody></table></div><br></div>';
